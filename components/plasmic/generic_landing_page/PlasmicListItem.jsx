...
import sty from "./PlasmicListItem.module.css"; // plasmic-import: ilzFVGDH8EBCyJ/css
import CheckCircleIcon from "./icons/PlasmicIcon__CheckCircle"; // plasmic-import: gJbyfJ7A9S5Q4X/icon
  ...
  return (
    ...
    >
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <CheckCircleIcon
            className={classNames(projectcss.all, sty.svg___71Nun)}
            role={"img"}
          />
        ),
