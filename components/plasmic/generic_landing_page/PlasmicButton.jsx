...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 01mjekF7qCxWMP/css
import AppleIcon from "./icons/PlasmicIcon__Apple"; // plasmic-import: 2ckXzOKO-Ulbt3/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg___4MDrx)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__k10X0)}
                role={"img"}
              />
            ),
