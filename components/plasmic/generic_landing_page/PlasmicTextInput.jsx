...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: RfuTAuNs8j3EaB/css
import SearchIcon from "./icons/PlasmicIcon__Search"; // plasmic-import: UDb4oQ7KMRPv6r/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchIcon
                className={classNames(projectcss.all, sty.svg__np76)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <CheckIcon
                className={classNames(projectcss.all, sty.svg__eakVa)}
                role={"img"}
              />
            ),
